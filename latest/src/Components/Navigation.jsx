...
//       {/* Video Modal */}
//       {isVideoModalOpen && (
//         <div className=" inset-0 bg-black bg-opacity-80 flex justify-center items-center z-50">
//           <div className="relative bg-gray-900 p-5 rounded-lg shadow-lg w-11/12 md:w-3/4 lg:w-1/2">
//             <button 
...
//               <source src="assets/bowl.mp4" type="video/mp4" />
...
//           >
//             <motion.div 
//               className="relative bg-gray-900 p-5 rounded-lg shadow-lg w-11/12 md:w-3/4 lg:w-1/2"
...
//                 &times;
//               </button>
//               <video autoPlay controls className="w-full h-auto rounded-lg">
...
//             whileHover={{ scale: 1.1 }}
//             whileTap={{ scale: 0.9 }}
//             className="bg-blue-500 text-white px-6 py-2 rounded-full font-semibold shadow-lg transition-all hover:bg-blue-600 relative overflow-hidden"
//             onClick={() => setIsVideoModalOpen(true)}
//           >
//             <span className="relative z-10">DEMO NXTMOOV ENGINE</span>
//             <motion.span 
...
//                 onClick={() => setIsVideoModalOpen(false)}
//               >
//                 <X className="h-8 w-8" /> {/* Use the same X icon as the mobile menu */}
//               </button>
